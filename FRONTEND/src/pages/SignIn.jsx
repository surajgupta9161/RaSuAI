    ...
    return (
        <div className='w-full h-screen bg-cover flex justify-center items-center' style={{ backgroundImage: `url(${bg})` }}>
            ...
            <form onSubmit={submitHandle} className='w-[90%] h-150 max-w-125 bg-[#00000070] backdrop-blur shadow-xl shadow-black rounded-2xl flex flex-col justify-center items-center gap-5 px-5'>
                ...
                <h1 className='text-[25px] font-semibold mb-7'>Sign In to <span className='text-green-600 font-bold'>RaSu</span> your <span className='text-blue-800 font-bold'> Virtual Assistant </span> </h1>
                ...
                <button className='bg-blue-500 text-white px-6 py-3 text-xl rounded-full cursor-pointer font-semibold active:scale-95 ' disabled={loading}>{loading ? "Loading..." : "Sign In"}</button>
                <p className='text-xl cursor-pointer' onClick={() => navigate("/signup")} >Don't have account! <span className='text-blue-400 '>Sign Up</span></p>
