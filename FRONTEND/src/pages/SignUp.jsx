...
const SignUp = () => {
    ...
    return (
        <div className='w-full h-screen bg-cover flex justify-center items-center' style={{ backgroundImage: `url(${bg})` }}>
            ...
            <form onSubmit={submitFunction} className='w-[90%] h-150 max-w-125 bg-[#00000070] backdrop-blur shadow-xl shadow-black rounded-2xl flex flex-col justify-center items-center gap-5 px-5'>
                ...
                <input type="text" placeholder='Enter your name' className='w-full h-15 outline-none border-2 bg-transparent rounded-full text-[18px] px-5 py-3 ' onChange={(e) => setName(e.target.value)} required />
                <input type="email" placeholder='Enter your mail' className='w-full h-15 outline-none border-2 bg-transparent rounded-full text-[18px]  px-5 py-3 ' onChange={(e) => setEmail(e.target.value)} required />
                <div className='w-full h-15 outline-none border-2 bg-transparent rounded-full text-[18px] relative'>
                    <input type={showPassword ? "text" : "password"} placeholder='Enter your password' className='w-full h-full outline-none bg-transparent rounded-full text-[18px] px-5 py-3 ' onChange={(e) => setPassword(e.target.value)} required />
